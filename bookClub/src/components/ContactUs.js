...
const ContactUs = ({ isDarkMode }) => {
  ...
  const textStyle = `mt-4 text-xl font-mono mx-auto leading-relaxed max-w-2xl ${isDarkMode ? 'text-white' : 'text-gray-700 '}`; 
  ...
  return (
    <div>
      ...
      <div className="min-h-screen flex flex-col text-center justify-center items-center py-12">
        ...
        <br />
        {/* Adjusted the section to start higher on the page */}
